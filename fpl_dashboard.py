...
if st.session_state.page == 'Home':
    ...
    try:
        ...
        st.dataframe(filtered_fixtures, height=1900,width=1400)  # Adjust the width as needed
    ...
    if 'position' in players.columns:
        ...
        if missing_metrics:
            ...
            st.dataframe(top_11_players[['first_name', 'web_name', 'team', 'position'] + selected_metrics],height=425,width=1200)
